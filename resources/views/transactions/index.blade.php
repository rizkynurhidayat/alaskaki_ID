...
<div class="max-w-5xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="{{ route('transactions.create') }}" class="bg-blue-600 text-white px-5 py-2.5 rounded-xl font-medium hover:bg-blue-700 shadow-sm shadow-blue-200 hover:shadow-md transition flex items-center gap-2 text-sm">
